...
//  _renderingContextbindTexture(GL_TEXTURE_2D, mTextureColorBuffer.get());
...
unsigned int FrameBufferCanvas::colorBufferId()
{
  return mTextureColorBuffer->value;
}

unsigned int FrameBufferCanvas::renderBufferId()
{
