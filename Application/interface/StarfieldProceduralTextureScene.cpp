...
public:
  ...
  void initializeScene(ICanvas* canvas, Scene* scene) override
  {
    ...
    _starfieldTexture = ProceduralTexturesLibrary::StarfieldProceduralTexture::New("StarFieldMaterialtext", 512, scene);
    ...
    auto space = Mesh::CreateCylinder("Space", 10.f * spaceScale, 0, 6.f * spaceScale, 20, 20, scene);
...
std::shared_ptr<IRenderableScene> MakeStarfieldProceduralTextureScene(ICanvas* canvas)
{
  return std::make_shared<StarfieldProceduralTextureScene>(canvas);
}
